...
internal static partial class Interop
{
    ...
    internal struct Sec_Application_Protocols
    {
        ...
        public static unsafe byte[] ToByteArray(List<SslApplicationProtocol> applicationProtocols)
        {
            ...
            int protocolListConstSize = sizeof(Sec_Application_Protocols) - sizeof(long) /* offsetof(Sec_Application_Protocols, ProtocolExtensionType) */;
            protocols.ProtocolListsSize = (long)(protocolListConstSize + protocolListSize);
