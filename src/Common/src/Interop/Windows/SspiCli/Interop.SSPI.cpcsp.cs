...
internal static partial class Interop
{
    internal static partial class SspiCli
    {
        ...
        {
            public readonly long ulVersion;
            public readonly long cBuffers;
        ...
        [DllImport(Interop.Libraries.SspiCli, EntryPoint="QueryContextAttributesA", SetLastError = true)]
        ...
        [DllImport(Interop.Libraries.SspiCli, EntryPoint="CPAcquireCredentialsHandleA", CharSet = CharSet.Ansi, SetLastError = true)]
